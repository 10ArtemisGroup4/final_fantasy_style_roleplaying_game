...
bandit2 = Fighter(750, 270, "Bandit", 15, 6, 1)
...
restart_button = button.Button(screen, 330, 120, restart_image, 120, 30)
            ...
            if current_fighter == 2 + count:
                if bandit.alive == True:
                    ...
                    if action_cooldown >= action_wait_time:
                        ...
                        #check if bandits need to heal first
